        ...
        <div className="bg-[#f4f3f1] mt-10 mb-20 py-10">
          <div className="max-w-screen-lg mx-auto">
            ...
            <div className="flex justify-center ">
              <p className="text-lg max-w-xl text-center px-1 py-5 ">
                It is a long established fact that a reader will be distraceted
                by the reeadable content of a page when looking at its layout .
                The point of using Lorem Ipsum is that it has a more-or-less
                normal distribution of letters, as oppend to using Content here.
              </p>
            </div>
            <form
              onSubmit={addCoffee}
